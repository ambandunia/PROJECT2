...
<body>
	...
	<div class="content-left">
		<font style=" color:darkblue; font:bold 24px 'cambria';">
						...
						<i class="icon icon-exclamation"></i> Solved Cases</font><hr style="margin:8px; border-bottom:1px solid #ccc;">
	 ...
	 $query="SELECT * FROM cases";
		...
		<tr>
		<td><b>Id</b></td> <td><b>Student</b></td></td><td><b>Desk Officer</b></td><td><b>Status</b></td></tr> ";
