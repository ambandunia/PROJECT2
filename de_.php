...
<?php include ("dbconn.php"); ?>
	<meta charset="utf-8">
	<title>Deactivating Account</title>
...
<body>
	...
	<div class="content-left">
		<font style=" color:darkblue; font:bold 24px 'cambria';">
						...
						<i class="icon icon-exclamation"></i> Deactivating Account</font><hr style="margin:8px; border-bottom:1px solid #ccc;">
	 ...
	 ?>
        ...
        <table align="center" width="400" border="0">
		 ...
		 <p align="center">
          <label>
            <input type="submit" name="de" class="button" value="Deactivate" />
          </label>
        </p>
		 </form>
<?php
