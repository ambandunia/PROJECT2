...
<!-- slider -->
 <link href="js/6/js-image-slider.css" rel="stylesheet" type="text/css" />
    <script src="js/6/mcVideoPlugin.js" type="text/javascript"></script>
    <script src="js/6/js-image-slider.js" type="text/javascript"></script>
