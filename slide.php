 <?php include "incls/connector.php"; ?>
  ...
  <div class="books_stat">
	...
	<ul>
		<?php 
		$counter = 0;
		$stat = mysqli_query($conn,"SELECT * FROM message GROUP BY msgid ASC LIMIT 10") or die(mysqli_error($conn));
		WHILE($stats = mysqli_fetch_array($stat)){
		$counter++;
		?>
		<li class="ctag tag<?php echo $counter; ?>" id="<?php echo $counter; ?>"><a href="#"><?php echo $stats['msg']; ?></a></li>
		<?php } ?>
	</ul>
