    ...
    <div id="slider1_container" style="position: relative; width: 475px;
        height: 300px;">
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(img/landscape/loading.gif) no-repeat center center;
                top: 0px; left: 0px;width: 100%;height:100%;">
            </div>
        </div>

        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; border-radius:5px; border:1px solid #aaa; left: 0px; top: 0px; width: 600px; height: 300px;
            overflow: hidden;">
			<div>
                <img u=image src="images/6.jpg" />
                <div u="thumb" style=""> Management</div>
                <div u="caption" t="L" tyle="position: absolute; top: 20px; left: 20px; width: 200px; height: 30px; color: #ffffff; font-size: 20px; line-height: 30px;">Project Topics</div>
                <div u="caption" t="CLIP|LR" style="position: absolute; top: 135px; left: 100px; width: 400px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;"></div>
            </div>
            <div>
                <img u=image src="images/field.jpg" />
                <div u="thumb">Our Vision</div>
                <div u="caption" t="MCLIP|L" style="position: absolute; top: 105px; left: 100px; width: 400px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">Research Topics</div>
                <div u="caption" t="LISTH|L" style="position: absolute; top: 165px; left: 100px; width: 400px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;"> Program Implementation</div>
            </div>
            <div>
                <img u=image src="images/4.jpg" />
                <div u="thumb">Project Topics</div>
			</div>
            <div>
                <img u=image src="images/chmsc/1.jpg" />
                <div u="thumb"></div>
                 </div>
            <div>
                <img u=image src="images/2.jpg" />
                <div u="thumb">Final Year Students</div>
                <div u="caption" t="DDG|TR" style="position: absolute; top: 135px; left: 100px; width: 150px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">Final Year Topics</div>
                <div u="caption" t="DODGEDANCE|L" style="position: absolute; top: 135px; left: 300px; width: 250px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">Final Year Students</div>
            </div>
            <div>
                <img u=image src="images/chmsc/3.jpg" />
                <div u="thumb"></div>
                </div>
            <div>
                <img u=image src="images/3.jpg" />
                <div u="thumb">Research</div>
            </div>
            <div>
                <img u=image src="images/chmsc/4.jpg" />
               <div u="thumb"></div>
        ...
        <div u="navigator" class="jssorb01" style="position: absolute; bottom: 16px; right: -115px;">
        ...
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora05r" style="width: 40px; height: 40px; top: 123px; right: -117px">
        </span>
        <!-- Arrow Navigator Skin End -->        <!-- Trigger -->
    </div>
    <!-- Jssor Slider End -->
